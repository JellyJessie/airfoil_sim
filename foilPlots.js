...
function plotGraph(lift, drag) {
  ...
  if (plot == 1) {
    ...
    if (outputButton != 1) Plotly.purge("tester");
  } else if (plot == 2) {
   ...
   */
    ...
    if (shapeSelect < 4)
      var trace1 = {
        x: [
          100 * (xm[0][npt2 - 0 + 1] / 4.0 + 0.5),
          100 * (xm[0][npt2 - 1 + 1] / 4.0 + 0.5),
          100 * (xm[0][npt2 - 2 + 1] / 4.0 + 0.5),
          100 * (xm[0][npt2 - 3 + 1] / 4.0 + 0.5),
          100 * (xm[0][npt2 - 4 + 1] / 4.0 + 0.5),
          100 * (xm[0][npt2 - 5 + 1] / 4.0 + 0.5),
          100 * (xm[0][npt2 - 6 + 1] / 4.0 + 0.5),
          100 * (xm[0][npt2 - 7 + 1] / 4.0 + 0.5),
          100 * (xm[0][npt2 - 8 + 1] / 4.0 + 0.5),
          100 * (xm[0][npt2 - 9 + 1] / 4.0 + 0.5),
          100 * (xm[0][npt2 - 10 + 1] / 4.0 + 0.5),
          100 * (xm[0][npt2 - 11 + 1] / 4.0 + 0.5),
          100 * (xm[0][npt2 - 12 + 1] / 4.0 + 0.5),
          100 * (xm[0][npt2 - 13 + 1] / 4.0 + 0.5),
          100 * (xm[0][npt2 - 14 + 1] / 4.0 + 0.5),
          100 * (xm[0][npt2 - 15 + 1] / 4.0 + 0.5),
          100 * (xm[0][npt2 - 16 + 1] / 4.0 + 0.5),
          100 * (xm[0][npt2 - 17 + 1] / 4.0 + 0.5),
          100 * (xm[0][npt2 - 18 + 1] / 4.0 + 0.5),
        ],
        y: [
          plp[npt2 - 0 + 1],
          plp[npt2 - 1 + 1],
      ...
      var trace1 = {
        x: [
          100 * (xm[0][npt2 - 0 + 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[0][npt2 - 1 + 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[0][npt2 - 2 + 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[0][npt2 - 3 + 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[0][npt2 - 4 + 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[0][npt2 - 5 + 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[0][npt2 - 6 + 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[0][npt2 - 7 + 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[0][npt2 - 8 + 1] / 4.0 + 0.5),
          100 * (xm[0][npt2 - 9 + 1] / 4.0 + 0.5),
          100 * (xm[0][npt2 - 10 + 1] / 4.0 + 0.5),
          100 * (xm[0][npt2 - 11 + 1] / 4.0 + 0.5),
          100 * (xm[0][npt2 - 12 + 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[0][npt2 - 13 + 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[0][npt2 - 14 + 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[0][npt2 - 15 + 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[0][npt2 - 16 + 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[0][npt2 - 17 + 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[0][npt2 - 18 + 1] / ((2.0 * radius) / lconv) + 0.5),
        ],
        y: [
          plp[npt2 - 0 + 1],
          plp[npt2 - 1 + 1],
    ...
    if (shapeSelect < 4)
      var trace2 = {
        x: [
          100 * (xm[1][npt2 + 0 - 1] / 4.0 + 0.5),
          100 * (xm[1][npt2 + 1 - 1] / 4.0 + 0.5),
          100 * (xm[1][npt2 + 2 - 1] / 4.0 + 0.5),
          100 * (xm[1][npt2 + 3 - 1] / 4.0 + 0.5),
          100 * (xm[1][npt2 + 4 - 1] / 4.0 + 0.5),
          100 * (xm[1][npt2 + 5 - 1] / 4.0 + 0.5),
          100 * (xm[1][npt2 + 6 - 1] / 4.0 + 0.5),
          100 * (xm[1][npt2 + 7 - 1] / 4.0 + 0.5),
          100 * (xm[1][npt2 + 8 - 1] / 4.0 + 0.5),
          100 * (xm[1][npt2 + 9 - 1] / 4.0 + 0.5),
          100 * (xm[1][npt2 + 10 - 1] / 4.0 + 0.5),
          100 * (xm[1][npt2 + 11 - 1] / 4.0 + 0.5),
          100 * (xm[1][npt2 + 12 - 1] / 4.0 + 0.5),
          100 * (xm[1][npt2 + 13 - 1] / 4.0 + 0.5),
          100 * (xm[1][npt2 + 14 - 1] / 4.0 + 0.5),
          100 * (xm[1][npt2 + 15 - 1] / 4.0 + 0.5),
          100 * (xm[1][npt2 + 16 - 1] / 4.0 + 0.5),
          100 * (xm[1][npt2 + 17 - 1] / 4.0 + 0.5),
          100 * (xm[1][npt2 + 18 - 1] / 4.0 + 0.5),
        ],
        y: [
          plp[npt2 + 0 - 1],
          plp[npt2 + 1 - 1],
      ...
      var trace2 = {
        x: [
          100 * (xm[1][npt2 + 0 - 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[1][npt2 + 1 - 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[1][npt2 + 2 - 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[1][npt2 + 3 - 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[1][npt2 + 4 - 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[1][npt2 + 5 - 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[1][npt2 + 6 - 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[1][npt2 + 7 - 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[1][npt2 + 8 - 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[1][npt2 + 9 - 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[1][npt2 + 10 - 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[1][npt2 + 11 - 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[1][npt2 + 12 - 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[1][npt2 + 13 - 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[1][npt2 + 14 - 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[1][npt2 + 15 - 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[1][npt2 + 16 - 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[1][npt2 + 17 - 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[1][npt2 + 18 - 1] / ((2.0 * radius) / lconv) + 0.5),
        ],
        y: [
          plp[npt2 + 0 - 1],
          plp[npt2 + 1 - 1],
    ...
    Plotly.newPlot("tester", data, layout, { displayModeBar: false });
    if (outputButton != 5) Plotly.purge("tester");
  } else if (plot == 3) {
    ...
    if (shapeSelect < 4)
      ...
      var trace1 = {
        x: [
          ...
          100 * (xm[0][npt2 - 6 + 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[0][npt2 - 7 + 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[0][npt2 - 8 + 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[0][npt2 - 9 + 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[0][npt2 - 10 + 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[0][npt2 - 11 + 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[0][npt2 - 12 + 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[0][npt2 - 13 + 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[0][npt2 - 14 + 1] / ((2.0 * radius) / lconv) + 0.5),
          100 * (xm[0][npt2 - 15 + 1] / ((2.0 * radius) / lconv) + 0.5),
   ...
   * Lift vs Angle plot
   */
    document.getElementById("dropdown1").value == "liftOption" &&
    plot == 5
  ) {
    npt = 21;
    var del = 40.0 / (npt - 1);
    ...
    if (getUnits() == 1) fconv = 1.0;
    else if (getUnits() == 2) fconv = 4.448;
   ...
   */
    document.getElementById("dropdown1").value == "clOption" &&
    plot == 5
  ) {
    npt = 21;
    var del = 40.0 / (npt - 1);
   ...
   * Drag vs angle
   */
    document.getElementById("dropdown1").value == "dragVs" &&
    plot == 5
  ) {
    npt = 21;
    var del = 40.0 / (npt - 1);
   ...
   */
    document.getElementById("dropdown1").value == "cdOption" &&
    plot == 5
  ) {
    npt = 21;
    var del = 40.0 / (npt - 1);
   ...
   * Lift vs speed plot
   */
    document.getElementById("dropdown2").value == "liftVsOption" &&
    plot == 8
  ) {
    var npt = 20;
    var ntr = 1;
   ...
   * Drag vs speed plot
   */
    document.getElementById("dropdown2").value == "dragVsOption" &&
    plot == 8
  ) {
    var npt = 20;
    var ntr = 1;
   ...
   */
    ...
    if (environmentSelect == 1) {
      altmax = 49500;
    } else if (environmentSelect == 2) altmax = 15000;
    ...
    for (ic = 1; ic <= npt; ++ic) {
      ...
      if (environmentSelect == 1) {
        ...
        plty[0][ic] =
          (fconv * lftref * ppl) / (tpl * 53.3 * 32.17) / shape.getRhoEarth();
      } else if (environmentSelect == 2) {
        if (hpl <= 22960) {
        ...
        plty[0][ic] =
          (fconv * lftref * ppl) / (tpl * 1149) / shape.getRhoMars();
      }
    }
   ...
   */
    ...
    for (ic = 1; ic <= npt; ++ic) {
      ...
      if (environmentSelect == 1) {
        ...
        plty[0][ic] =
          (fconv * drgref * ppl) / (tpl * 53.3 * 32.17) / shape.getRhoEarth();
      } else if (environmentSelect == 2) {
        if (hpl <= 22960) {
          tpl = 434.02 - (0.548 * hpl) / 1000;
          ppl = 14.62 * Math.pow(2.71828, -0.00003 * hpl);
        ...
        plty[0][ic] =
          (fconv * drgref * ppl) / (tpl * 1149) / shape.getRhoMars();
      }
    }
...
function probe() {
  var velUnits;
  if (getUnits() == 1) velUnits = " mph";
  else if (getUnits() == 2) velUnits = " km/h";
  var level = velocity;
...
function getDrag(cldin) {
  ...
  var recyl = [
    0.1, 0.2, 0.4, 0.5, 0.6, 0.8, 1.0, 2.0, 4.0, 5.0, 6.0, 8.0, 10.0, 20.0,
    40.0, 50.0, 60.0, 80.0, 100.0, 200.0, 400.0, 500.0, 600.0, 800.0, 1000,
    2000, 4000, 5000, 6000, 8000, 10000, 100000, 200000, 400000, 500000, 600000,
    800000, 1000000, 2000000, 4000000, 5000000, 6000000, 8000000, 1000000000000,
  ];
  var cdcyl = [
    70, 35, 20, 17, 15, 13, 10, 7, 5.5, 5.0, 4.5, 4, 3.5, 3.0, 2.7, 2.5, 2.0,
    2.0, 1.9, 1.6, 1.4, 1.2, 1.1, 1.1, 1.0, 1.2, 1.4, 1.4, 1.5, 1.5, 1.6, 1.6,
    1.4, 0.4, 0.28, 0.32, 0.4, 0.45, 0.6, 0.8, 0.8, 0.85, 0.9, 0.9,
  ];
  var resps = [
    0.1, 0.2, 0.4, 0.5, 0.6, 0.8, 1.0, 2.0, 4.0, 5.0, 6.0, 8.0, 10.0, 20, 40,
    50, 60, 80.0, 100.0, 200, 400, 500, 600, 800.0, 1000, 2000, 4000, 5000,
    6000, 8000, 10000, 20000, 40000, 50000, 60000, 80000, 100000, 200000,
    400000, 500000, 600000, 800000, 1000000, 2000000, 4000000, 5000000, 6000000,
    8000000, 1000000000000,
  ];

  var cdsps = [
    270, 110, 54, 51, 40, 35, 28, 15, 8.5, 7.5, 6.0, 5.4, 4.9, 3.1, 1.9, 1.8,
    1.5, 1.3, 1.1, 0.81, 0.6, 0.58, 0.56, 0.5, 0.49, 0.4, 0.41, 0.415, 0.42,
    0.43, 0.44, 0.44, 0.45, 0.455, 0.46, 0.47, 0.48, 0.47, 0.1, 0.098, 0.1,
    0.15, 0.19, 0.3, 0.35, 0.37, 0.4, 0.4, 0.42,
  ];
  var cdspr = [
    270, 110, 54, 51, 40, 35, 28, 15, 8.5, 7.5, 6.0, 5.4, 4.9, 3.1, 1.9, 1.8,
    1.5, 1.3, 1.1, 0.81, 0.6, 0.58, 0.56, 0.5, 0.49, 0.4, 0.41, 0.415, 0.42,
    0.43, 0.44, 0.44, 0.45, 0.455, 0.46, 0.42, 0.15, 0.27, 0.33, 0.35, 0.37,
    0.38, 0.39, 0.4, 0.41, 0.41, 0.42, 0.43, 0.44,
  ];
  var cdspg = [
    270, 110, 54, 51, 40, 35, 28, 15, 8.5, 7.5, 6.0, 5.4, 4.9, 3.1, 1.9, 1.8,
    1.5, 1.3, 1.1, 0.81, 0.6, 0.58, 0.56, 0.5, 0.49, 0.4, 0.41, 0.415, 0.42,
    0.43, 0.44, 0.44, 0.28, 0.255, 0.24, 0.24, 0.25, 0.26, 0.27, 0.29, 0.33,
    0.37, 0.4, 0.41, 0.42, 0.42, 0.43, 0.44, 0.45,
  ];
  if (liftAnalisis == 2) {
    dragco = 0;
    ...
    switch (shapeSelect) {
      ...
      case 2: { //elliptical drag logic
        ...
        dragCam20Thk5 =
          1e-8 * Math.pow(alfd, 6) -
          2e-8 * Math.pow(alfd, 5) -
          7e-6 * Math.pow(alfd, 4) +
          1e-5 * Math.pow(alfd, 3) +
          0.0015 * Math.pow(alfd, 2) +
          0.0007 * alfd +
          0.1594;
        ...
        dragCam0Thk10 =
          ...
          4e-8 * Math.pow(alfd, 5) -
          3e-6 * Math.pow(alfd, 4) -
          9e-6 * Math.pow(alfd, 3) +
          0.0013 * Math.pow(alfd, 2) +
          0.0007 * alfd +
          0.0112;
        dragCam10Thk10 =
          -4e-9 * Math.pow(alfd, 6) -
        ...
        dragCam20Thk10 =
          ...
          9e-8 * Math.pow(alfd, 5) +
          3e-6 * Math.pow(alfd, 4) +
          6e-5 * Math.pow(alfd, 3) +
          0.0005 * Math.pow(alfd, 2) -
          0.0088 * alfd +
          0.2088;

        dragCam0Thk20 =
          -7e-9 * Math.pow(alfd, 6) -
          1e-7 * Math.pow(alfd, 5) +
          4e-6 * Math.pow(alfd, 4) +
          6e-5 * Math.pow(alfd, 3) +
          0.0001 * Math.pow(alfd, 2) -
          0.0087 * alfd +
          0.0596;
        ...
        if (-20.0 <= camd && camd < -10.0) {
          dragThk5 =
            (camd / 10 + 2) * (dragCam10Thk5 - dragCam20Thk5) + dragCam20Thk5;
          dragThk10 =
            (camd / 10 + 2) * (dragCam10Thk10 - dragCam20Thk10) +
            dragCam20Thk10;
          dragThk20 =
            (camd / 10 + 2) * (dragCam10Thk20 - dragCam20Thk20) +
            dragCam20Thk20;
          ...
          dragThk5 =
            (camd / 10 + 1) * (dragCam0Thk5 - dragCam10Thk5) + dragCam10Thk5;
          dragThk10 =
            (camd / 10 + 1) * (dragCam0Thk10 - dragCam10Thk10) + dragCam10Thk10;
          dragThk20 =
            (camd / 10 + 1) * (dragCam0Thk20 - dragCam10Thk20) + dragCam10Thk20;
          ...
          dragThk5 =
            (camd / 10) * (dragCam10Thk5 - dragCam0Thk5) + dragCam0Thk5;
          dragThk10 =
            (camd / 10) * (dragCam10Thk10 - dragCam0Thk10) + dragCam0Thk10;
          dragThk20 =
            (camd / 10) * (dragCam10Thk20 - dragCam0Thk20) + dragCam0Thk20;
          ...
          dragThk5 =
            (camd / 10 - 1) * (dragCam20Thk5 - dragCam10Thk5) + dragCam10Thk5;
          dragThk10 =
            (camd / 10 - 1) * (dragCam20Thk10 - dragCam10Thk10) +
            dragCam10Thk10;
          dragThk20 =
            (camd / 10 - 1) * (dragCam20Thk20 - dragCam10Thk20) +
            dragCam10Thk20;
      ...
      case 3: { //flat plate drag logic
        ...
        dragCam5 =
          1e-8 * Math.pow(alfd, 6) +
          4e-8 * Math.pow(alfd, 5) -
          9e-6 * Math.pow(alfd, 4) -
          1e-5 * Math.pow(alfd, 3) +
          0.0021 * Math.pow(alfd, 2) +
          0.0033 * alfd +
          0.006;
        dragCam10 =
          -9e-9 * Math.pow(alfd, 6) -
      ...
      case 4: { //cylinder drag logic
        ...
        dragco =
          ((cdcyl[ifound + 1] - cdcyl[ifound]) /
            (recyl[ifound + 1] - recyl[ifound])) *
            (reynolds - recyl[ifound]) +
          cdcyl[ifound];
      ...
      case 5: { //sphere drag logic
        ...
        if (dragBall == 1) {
          // smooth ball
          dragco =
            ((cdsps[ifound + 1] - cdsps[ifound]) /
              (resps[ifound + 1] - resps[ifound])) *
              (reynolds - resps[ifound]) +
            cdsps[ifound];
        }
        if (dragBall == 2) {
          // rough ball
          dragco =
            ((cdspr[ifound + 1] - cdspr[ifound]) /
              (resps[ifound + 1] - resps[ifound])) *
              (reynolds - resps[ifound]) +
            cdspr[ifound];
        }
